...
public class fire_allnum extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView = findViewById(R.id.FireTeleRecycler);
        mhotline_recycler = findViewById(R.id.FireMobileRecycler);
...
// Get the arrays from the string.xml file
        String[] tnames = getResources().getStringArray(R.array.fthotline_names);
        String[] tnumbers = getResources().getStringArray(R.array.fthotline_numbers);
...
// Iterate through the arrays, creating a new HotlineInfo object for each element and adding it to the hotlineInfos list
        ...
        hotlineAllNumAdapter = new HotlineAllNumAdapter(fire_allnum.this, hotlineInfos);
...
//MobileNumbers
        ...
        // Get the arrays from the string.xml file
        String[] mnames = getResources().getStringArray(R.array.fmhotline_names);
        String[] mnumbers = getResources().getStringArray(R.array.fmhotline_numbers);
        ...
        HotlineMobileNumAdapter hotlineMobileNumAdapter = new HotlineMobileNumAdapter(fire_allnum.this, mhotlineInfos);
        mhotline_recycler.setAdapter(hotlineMobileNumAdapter);

//---  END OF FIRE SERVICES ----
