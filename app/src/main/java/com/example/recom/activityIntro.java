...
public class activityIntro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iList.add(new itemIntro("WELCOME!","ReCom or Re-Communicate is a sector based app which aims to help a community to provide good communication inside and outside the vicinity. This app is to make communication at ease for the betterment of their environment.",R.drawable.recomlogo2));
