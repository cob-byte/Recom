...
public class activityIntro extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        iList.add(new itemIntro("Re-Communication","ReCom or Re-Communicate is a sector based app which aims to help a community to provide good communication inside and outside the vicinity. This app is to make communication at ease for the betterment of their environment.",R.drawable.recomlogo));
        ...
        iList.add(new itemIntro("Pasuyo","A service that gives a chance to the community who cannot do such activity at the time needed. Fill in exact information to specify one's \"pasuyo\" and the type of service that shall be done. For the improvement of the system, feedbacks are available after the service is completed. Both \"nakikisuyo\" and the \"susuyo\" will benefit as the \"susuyo\" will obtain points that may benefit one in the future.",R.drawable.pasuyo));
